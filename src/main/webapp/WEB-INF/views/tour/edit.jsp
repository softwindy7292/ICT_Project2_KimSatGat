...
<body>
    ...
    <div class="container mt-5">
        <h2 class="text-center">관광지 수정</h2>
        <form action="${pageContext.request.contextPath}/tour/update" method="post" class="mt-4 form-container">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="tour_address" name="tour_address" value="${tour.tour_address}" required />
            </div>
            <div class="form-group">
                <label for="tour_cmmt">설명:</label>
                <textarea class="form-control" id="tour_cmmt" name="tour_cmmt" rows="4" required>${tour.tour_cmmt}</textarea>
            </div>
            <div class="form-group">
                <label for="tour_telno">전화번호:</label>
                <input type="text" class="form-control" id="tour_telno" name="tour_telno" value="${tour.tour_telno}" required />
            </div>
            <div class="form-group">
                <label for="custom_cnt">수용 인원 수:</label>
                <input type="number" class="form-control" id="custom_cnt" name="custom_cnt" value="${tour.custom_cnt}" required />
            </div>
            <div class="form-group">
                <label for="car_cnt">주차 가능 수:</label>
                <input type="number" class="form-control" id="car_cnt" name="car_cnt" value="${tour.car_cnt}" required />
            </div>
            <div class="text-center">
                <button type="submit" class="btn btn-primary btn-rounded">수정</button>
                <a href="${pageContext.request.contextPath}/tour/list" class="btn btn-secondary btn-rounded">목록</a>
            </div>
        </form>
    </div>
