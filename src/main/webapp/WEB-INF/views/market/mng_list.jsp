...
<script type="text/javascript">
    function openMngDetail(marketCode) {
        ...
        var url = "${pageContext.request.contextPath}/market/mngdetail?market_code=" + marketCode;
	...
	<div class="container">
		<div id="header">
			<div
				...
				<h1 style="margin: 0; padding-right: 10px;">김삿갓팀 전통시장 안내시스템
					[관리자용]</h1>
				<div style="display: flex;">
					<button style="margin-right: 10px;" onclick="openMngCreate()">
						시장등록</button>
		...
		<form id="listForm"
			action="${pageContext.request.contextPath}/market/mngsearchlist"
			onsubmit="return formCheck()" method="get">
			<td>
				<div class="text-center">
					<span>지역구분</span> <select id="area_code" name="area_code">
						<option value="" selected disabled>전체 또는 지역 선택</option>
						...
						<option value="" selected disabled>전체 또는 시장유형선택</option>
						<option value="9">전체</option>
						<option value="1">상설장</option>
						<option value="2">상설+5일장</option>
						<option value="3">5일장</option>
					</select> <span>&nbsp;&nbsp;<span
						style="font-weight: bold; color: red;">또는</span>&nbsp;&nbsp;
					</span> <span>시장명</span>
				...
				<tbody id="result">
					<c:forEach var="market" items="${marketList}">
						<tr>
							...
							<td align="center"><button
									onclick="openMngDetail('${market.market_code}')">
									상세보기</a>
								</button></td>
						</tr>
					</c:forEach>
